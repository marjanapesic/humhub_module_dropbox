    ...
    <div class="panel panel-default">
		<div class="panel-body">
            ...
            <div class="form-group">
                <span id="dropbox-open" class="pull-right"><i class="fa fa-folder-open"></i></span>
                <ul class="tag_input <?php $errors = $model->getErrors(); if(!empty($errors['dropboxFileId'])) echo "error"?>"
                     id="dropbox_file_tags" style="margin-right:20px;" >
                    <li>
            ...
            <div class="form-group">
                <?php echo $form->textArea($model, 'message', array('class' => 'form-control', 'placeholder' => Yii::t('DropboxModule.views_dropbox_create', 'Describe your images'))); ?>
